...
struct regs_sets {
	union regs {
		...
		Uint16 UWord;
		Sint16 SWord;
	} regs[12];     // DGS: This was originally [10] but there are [PC] references which try to access index 10 which is valid for a zero-based array
                    // I added two more elements to stay consistent with how this structure appears to be used.  It appears that everyother element
                    // is accessed.  Me thinks the original author didn't understand unions and/or arrays.
} regs_sets;
