...
program_start:
	...
	ld	a,%00000111				; %.....1.. = turn it on
	ld	[rTAC],a				; %......11 = 16384 Hz

	ld	a,$80					; Set Timer Modulo to 0
	ld	[rTMA],a

	ld	hl,int_array_timer
	ld	bc,timer_interrupt
	call load_int_function		; Load timer_interrupt address into timer interrupt array
